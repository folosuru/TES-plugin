...
//		$webhook = Sender::create("https://discord.com/api/webhooks/816533633208549376/CyIo52uELVMlPrYjwD2xLzLOf5HXblG9UjNNFSmUbvXgiyCZFIwkzhZOTs-0JkRdNq_5")
//			->add($content)
...
//		Sender::send($webhook);
	...
	public function onCommand(CommandSender $sender, Command $command, string $label, array $args) : bool{
		switch($command->getName()){
			...
			case "savepda":
				...
				file_put_contents("plugin_data/TES/".$sender->getName().".json",$arr);
				return true;
			default:
	...
	public function onLogin(PlayerLoginEvent $event){
		...
		#	->setCustomName("test");
		#Sender::send($webhook);
		if (file_exists("plugin_data/TES/".$event->getPlayer()->getName().".json")){
			$player_data_tmp = file_get_contents("plugin_data/TES/".$event->getPlayer()->getName().".json");
			...
			$this->player_data[$event->getPlayer()->getName()] = array('name' => $event->getPlayer()->getName() , "first_login" => 1 ,"ACP" => 0 );
